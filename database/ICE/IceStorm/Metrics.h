...
class ICE_STORM_LIB_API TopicMetrics : virtual public ::IceProxy::IceMX::Metrics
{
public:
    ...
    ::IceInternal::ProxyHandle<TopicMetrics> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<TopicMetrics*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
...
class ICE_STORM_LIB_API SubscriberMetrics : virtual public ::IceProxy::IceMX::Metrics
{
public:
    ...
    ::IceInternal::ProxyHandle<SubscriberMetrics> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<SubscriberMetrics*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
