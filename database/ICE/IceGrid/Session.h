...
public:
    ...
    ::Ice::ObjectPrx allocateObjectById(const ::Ice::Identity& __p_id)
    {
        return allocateObjectById(__p_id, 0);
    }
    ::Ice::ObjectPrx allocateObjectById(const ::Ice::Identity& __p_id, const ::Ice::Context& __ctx)
    {
        return allocateObjectById(__p_id, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_allocateObjectById(const ::Ice::Identity& __p_id, const ::IceInternal::Function<void (const ::Ice::ObjectPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_allocateObjectById(__p_id, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_allocateObjectById(const ::Ice::Identity& __p_id, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_allocateObjectById(__p_id, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_allocateObjectById(const ::Ice::Identity& __p_id, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::ObjectPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_allocateObjectById(__p_id, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_allocateObjectById(const ::Ice::Identity& __p_id, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_allocateObjectById(__p_id, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_allocateObjectById(const ::Ice::Identity& __p_id, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::Ice::ObjectPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_allocateObjectById(const ::Ice::Identity& __p_id)
    {
        return begin_allocateObjectById(__p_id, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_allocateObjectById(const ::Ice::Identity& __p_id, const ::Ice::Context& __ctx)
    {
        return begin_allocateObjectById(__p_id, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_allocateObjectById(const ::Ice::Identity& __p_id, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_allocateObjectById(__p_id, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_allocateObjectById(const ::Ice::Identity& __p_id, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_allocateObjectById(__p_id, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_allocateObjectById(const ::Ice::Identity& __p_id, const ::IceGrid::Callback_Session_allocateObjectByIdPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_allocateObjectById(__p_id, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_allocateObjectById(const ::Ice::Identity& __p_id, const ::Ice::Context& __ctx, const ::IceGrid::Callback_Session_allocateObjectByIdPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_allocateObjectById(__p_id, &__ctx, __del, __cookie);
    }

    ::Ice::ObjectPrx end_allocateObjectById(const ::Ice::AsyncResultPtr&);
    
private:

    ::Ice::ObjectPrx allocateObjectById(const ::Ice::Identity&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_allocateObjectById(const ::Ice::Identity&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
    
public:

    ::Ice::ObjectPrx allocateObjectByType(const ::std::string& __p_type)
    {
        return allocateObjectByType(__p_type, 0);
    }
    ::Ice::ObjectPrx allocateObjectByType(const ::std::string& __p_type, const ::Ice::Context& __ctx)
    {
        return allocateObjectByType(__p_type, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_allocateObjectByType(const ::std::string& __p_type, const ::IceInternal::Function<void (const ::Ice::ObjectPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_allocateObjectByType(__p_type, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_allocateObjectByType(const ::std::string& __p_type, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_allocateObjectByType(__p_type, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_allocateObjectByType(const ::std::string& __p_type, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::ObjectPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_allocateObjectByType(__p_type, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_allocateObjectByType(const ::std::string& __p_type, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_allocateObjectByType(__p_type, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_allocateObjectByType(const ::std::string& __p_type, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::Ice::ObjectPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_allocateObjectByType(const ::std::string& __p_type)
    {
        return begin_allocateObjectByType(__p_type, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_allocateObjectByType(const ::std::string& __p_type, const ::Ice::Context& __ctx)
    {
        return begin_allocateObjectByType(__p_type, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_allocateObjectByType(const ::std::string& __p_type, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_allocateObjectByType(__p_type, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_allocateObjectByType(const ::std::string& __p_type, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_allocateObjectByType(__p_type, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_allocateObjectByType(const ::std::string& __p_type, const ::IceGrid::Callback_Session_allocateObjectByTypePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_allocateObjectByType(__p_type, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_allocateObjectByType(const ::std::string& __p_type, const ::Ice::Context& __ctx, const ::IceGrid::Callback_Session_allocateObjectByTypePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_allocateObjectByType(__p_type, &__ctx, __del, __cookie);
    }

    ::Ice::ObjectPrx end_allocateObjectByType(const ::Ice::AsyncResultPtr&);
    
private:

    ::Ice::ObjectPrx allocateObjectByType(const ::std::string&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_allocateObjectByType(const ::std::string&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
    
public:

    void releaseObject(const ::Ice::Identity& __p_id)
    {
        releaseObject(__p_id, 0);
    }
    void releaseObject(const ::Ice::Identity& __p_id, const ::Ice::Context& __ctx)
    {
        releaseObject(__p_id, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_releaseObject(const ::Ice::Identity& __p_id, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_releaseObject(__p_id, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_releaseObject(const ::Ice::Identity& __p_id, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_releaseObject(__p_id, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_releaseObject(const ::Ice::Identity& __p_id, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_releaseObject(__p_id, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_releaseObject(const ::Ice::Identity& __p_id, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_releaseObject(__p_id, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_releaseObject(const ::Ice::Identity& __p_id, const ::Ice::Context* __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_releaseObject(const ::Ice::Identity& __p_id)
    {
        return begin_releaseObject(__p_id, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_releaseObject(const ::Ice::Identity& __p_id, const ::Ice::Context& __ctx)
    {
        return begin_releaseObject(__p_id, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_releaseObject(const ::Ice::Identity& __p_id, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_releaseObject(__p_id, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_releaseObject(const ::Ice::Identity& __p_id, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_releaseObject(__p_id, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_releaseObject(const ::Ice::Identity& __p_id, const ::IceGrid::Callback_Session_releaseObjectPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_releaseObject(__p_id, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_releaseObject(const ::Ice::Identity& __p_id, const ::Ice::Context& __ctx, const ::IceGrid::Callback_Session_releaseObjectPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_releaseObject(__p_id, &__ctx, __del, __cookie);
    }

    void end_releaseObject(const ::Ice::AsyncResultPtr&);
    
private:

    void releaseObject(const ::Ice::Identity&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_releaseObject(const ::Ice::Identity&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
    
public:

    void setAllocationTimeout(::Ice::Int __p_timeout)
    {
        setAllocationTimeout(__p_timeout, 0);
    }
    void setAllocationTimeout(::Ice::Int __p_timeout, const ::Ice::Context& __ctx)
    {
        setAllocationTimeout(__p_timeout, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_setAllocationTimeout(::Ice::Int __p_timeout, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_setAllocationTimeout(__p_timeout, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_setAllocationTimeout(::Ice::Int __p_timeout, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setAllocationTimeout(__p_timeout, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setAllocationTimeout(::Ice::Int __p_timeout, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_setAllocationTimeout(__p_timeout, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setAllocationTimeout(::Ice::Int __p_timeout, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setAllocationTimeout(__p_timeout, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_setAllocationTimeout(::Ice::Int __p_timeout)
    {
        return begin_setAllocationTimeout(__p_timeout, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setAllocationTimeout(::Ice::Int __p_timeout, const ::Ice::Context& __ctx)
    {
        return begin_setAllocationTimeout(__p_timeout, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setAllocationTimeout(::Ice::Int __p_timeout, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setAllocationTimeout(__p_timeout, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setAllocationTimeout(::Ice::Int __p_timeout, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setAllocationTimeout(__p_timeout, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setAllocationTimeout(::Ice::Int __p_timeout, const ::IceGrid::Callback_Session_setAllocationTimeoutPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setAllocationTimeout(__p_timeout, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setAllocationTimeout(::Ice::Int __p_timeout, const ::Ice::Context& __ctx, const ::IceGrid::Callback_Session_setAllocationTimeoutPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setAllocationTimeout(__p_timeout, &__ctx, __del, __cookie);
    }

    void end_setAllocationTimeout(const ::Ice::AsyncResultPtr&);
    
private:

    void setAllocationTimeout(::Ice::Int, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_setAllocationTimeout(::Ice::Int, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
