...
class ICE_GRID_API Locator : virtual public ::IceProxy::Ice::Locator
{
public:
...
public:
    ...
    ::IceGrid::RegistryPrx end_getLocalRegistry(const ::Ice::AsyncResultPtr&);
    
private:

    ::IceGrid::RegistryPrx getLocalRegistry(const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_getLocalRegistry(const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    ::IceGrid::QueryPrx end_getLocalQuery(const ::Ice::AsyncResultPtr&);
    
private:

    ::IceGrid::QueryPrx getLocalQuery(const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_getLocalQuery(const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
