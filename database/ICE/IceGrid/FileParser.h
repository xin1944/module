...
class ICE_GRID_API FileParser : virtual public ::IceProxy::Ice::Object
{
public:

    ::IceGrid::ApplicationDescriptor parse(const ::std::string& __p_xmlFile, const ::IceGrid::AdminPrx& __p_adminProxy)
    {
        return parse(__p_xmlFile, __p_adminProxy, 0);
    }
    ::IceGrid::ApplicationDescriptor parse(const ::std::string& __p_xmlFile, const ::IceGrid::AdminPrx& __p_adminProxy, const ::Ice::Context& __ctx)
    {
        return parse(__p_xmlFile, __p_adminProxy, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_parse(const ::std::string& __p_xmlFile, const ::IceGrid::AdminPrx& __p_adminProxy, const ::IceInternal::Function<void (const ::IceGrid::ApplicationDescriptor&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_parse(__p_xmlFile, __p_adminProxy, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_parse(const ::std::string& __p_xmlFile, const ::IceGrid::AdminPrx& __p_adminProxy, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_parse(__p_xmlFile, __p_adminProxy, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_parse(const ::std::string& __p_xmlFile, const ::IceGrid::AdminPrx& __p_adminProxy, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::IceGrid::ApplicationDescriptor&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_parse(__p_xmlFile, __p_adminProxy, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_parse(const ::std::string& __p_xmlFile, const ::IceGrid::AdminPrx& __p_adminProxy, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_parse(__p_xmlFile, __p_adminProxy, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
...
public:
    ...
    ::Ice::AsyncResultPtr begin_parse(const ::std::string& __p_xmlFile, const ::IceGrid::AdminPrx& __p_adminProxy)
    {
        return begin_parse(__p_xmlFile, __p_adminProxy, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_parse(const ::std::string& __p_xmlFile, const ::IceGrid::AdminPrx& __p_adminProxy, const ::Ice::Context& __ctx)
    {
        return begin_parse(__p_xmlFile, __p_adminProxy, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_parse(const ::std::string& __p_xmlFile, const ::IceGrid::AdminPrx& __p_adminProxy, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_parse(__p_xmlFile, __p_adminProxy, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_parse(const ::std::string& __p_xmlFile, const ::IceGrid::AdminPrx& __p_adminProxy, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_parse(__p_xmlFile, __p_adminProxy, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_parse(const ::std::string& __p_xmlFile, const ::IceGrid::AdminPrx& __p_adminProxy, const ::IceGrid::Callback_FileParser_parsePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_parse(__p_xmlFile, __p_adminProxy, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_parse(const ::std::string& __p_xmlFile, const ::IceGrid::AdminPrx& __p_adminProxy, const ::Ice::Context& __ctx, const ::IceGrid::Callback_FileParser_parsePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_parse(__p_xmlFile, __p_adminProxy, &__ctx, __del, __cookie);
    }

    ::IceGrid::ApplicationDescriptor end_parse(const ::Ice::AsyncResultPtr&);
    
private:

    ::IceGrid::ApplicationDescriptor parse(const ::std::string&, const ::IceGrid::AdminPrx&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_parse(const ::std::string&, const ::IceGrid::AdminPrx&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    ::IceInternal::ProxyHandle<FileParser> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<FileParser*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
