...
class GLACIER2_API SessionMetrics : virtual public ::IceProxy::IceMX::Metrics
{
public:
    ...
    ::IceInternal::ProxyHandle<SessionMetrics> ice_invocationTimeout(int __timeout) const
    {
        return dynamic_cast<SessionMetrics*>(::IceProxy::Ice::Object::ice_invocationTimeout(__timeout).get());
    }
