...
public:
    ...
    ::std::string end_getCategoryForClient(const ::Ice::AsyncResultPtr&);
    
private:

    ::std::string getCategoryForClient(const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_getCategoryForClient(const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
    
public:

    ::Glacier2::SessionPrx createSession(const ::std::string& __p_userId, const ::std::string& __p_password)
    {
        return createSession(__p_userId, __p_password, 0);
    }
    ::Glacier2::SessionPrx createSession(const ::std::string& __p_userId, const ::std::string& __p_password, const ::Ice::Context& __ctx)
    {
        return createSession(__p_userId, __p_password, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_createSession(const ::std::string& __p_userId, const ::std::string& __p_password, const ::IceInternal::Function<void (const ::Glacier2::SessionPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
    ...
    ::Ice::AsyncResultPtr
    begin_createSession(const ::std::string& __p_userId, const ::std::string& __p_password, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Glacier2::SessionPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
...
private:
    ...
    ::Ice::AsyncResultPtr __begin_createSession(const ::std::string& __p_userId, const ::std::string& __p_password, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::Glacier2::SessionPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
...
public:
    ...
    ::Ice::AsyncResultPtr begin_createSession(const ::std::string& __p_userId, const ::std::string& __p_password, const ::Glacier2::Callback_Router_createSessionPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_createSession(__p_userId, __p_password, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_createSession(const ::std::string& __p_userId, const ::std::string& __p_password, const ::Ice::Context& __ctx, const ::Glacier2::Callback_Router_createSessionPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_createSession(__p_userId, __p_password, &__ctx, __del, __cookie);
    }

    ::Glacier2::SessionPrx end_createSession(const ::Ice::AsyncResultPtr&);
...
public:
    ...
    ::Glacier2::SessionPrx end_createSessionFromSecureConnection(const ::Ice::AsyncResultPtr&);
...
public:
    ...
    void end_refreshSession(const ::Ice::AsyncResultPtr&);
    
private:

    void refreshSession(const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_refreshSession(const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    void end_destroySession(const ::Ice::AsyncResultPtr&);
    
private:

    void destroySession(const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_destroySession(const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
